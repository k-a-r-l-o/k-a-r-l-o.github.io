...
<head>
  ...
  <style>
    ...
    th:nth-child(2),
    td:nth-child(2) {
      width: 15%; /* Adjust width of the second column */
    }
    ...
    th:nth-child(4),
    td:nth-child(4) {
      width: 25%; /* Adjust width of the 4th column */
    }

    th:nth-child(5),
    td:nth-child(5) {
      width: 25%; /* Adjust width of the 5th column */
    }
    ...
    <div class="bodycontainer" >
        <div class="menu">
            <div class="buttonContainer">
                ...
                <button title="Partylists" title="Councils" onclick="switchHTML('Partylist.php')"><div><img src="partylist.svg" alt="partylist icon"></div><div>Partylist</div> </button>
                ...
                <button title="Logs" id="selected"><div><img src="log.svg" alt="log icon"></div><div>Log</div></button>
                <br>
            ...
            <div class="tableandnav">
                <div class="tablecontainer">
                    <table id="Results">
                        ...
                        <tr>
                            <td class="tdfirst">03-24-24</td>
                            <td>08:20</td>
                            <td>Admin115</td>
                            <td>Admin-Technical</td>
                            <td class="tdlast">Add Candidate</td>
                        </tr>
                        <tr>
                            <td class="tdfirst">03-24-24</td>
                            <td>09:45</td>
                        ...
                        <tr>
                            ...
                            <td>Admin0012</td>
                            <td>Admin-Front</td>
                            <td class="tdlast">Edit Candidate</td>
                        </tr>
                        <tr>
                            <td class="tdfirst">03-24-24</td>
                            <td>15:45</td>
